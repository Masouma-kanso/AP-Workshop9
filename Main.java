...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("2) Longest word and its length: " + longestWord + " (" + longestWordLength + ")");
            System.out.println("3) Shortest word and its length: " + shortestWord + " (" + shortestWordLength + ")");
